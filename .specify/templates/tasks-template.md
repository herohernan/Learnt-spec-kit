...
**Tests**: Tests are REQUIRED for every behavior change unless the work is
strictly documentation-only or metadata-only. If tests are omitted, the task
list MUST explain why.
...
- [ ] T004 [P] Configure automated test, UX validation, and performance measurement tooling
...
- [ ] T019 [US1] Validate UX states and copy consistency for the story
- [ ] T020 [US1] Measure performance against the story budget and record results
...
- [ ] T021 [P] [US2] Unit test for [behavior] in tests/unit/test_[name].py
...
- [ ] T027 [US2] Validate UX states and copy consistency for the story
- [ ] T028 [US2] Measure performance against the story budget and record results
...
- [ ] T030 [P] [US3] Unit test for [behavior] in tests/unit/test_[name].py
...
- [ ] T036 [US3] Validate UX states and copy consistency for the story
- [ ] T037 [US3] Measure performance against the story budget and record results
...
- [ ] TXXX Consolidate cross-story UX consistency validation
...
- UX validation before story sign-off
- Performance verification before story sign-off
...
Task: "Unit test for [behavior] in tests/unit/test_[name].py"
...
- Capture UX consistency checks for changed user-facing flows
- Capture performance verification for changed critical flows
